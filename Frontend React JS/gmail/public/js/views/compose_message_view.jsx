  ...
  render() {
    ...
    return (
       ...
       <header className="title">
          <h3>{title}</h3>
          <button className="btn btn-link" onClick={this.props.onCancelReply} 
       ...
       <footer>
          <button type="button" className="btn btn-default" onClick={this.props.onCancelReply}>Cancel</button>
